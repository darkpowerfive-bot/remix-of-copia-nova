...
// Deepgram Aura voice mappings by language
const DEEPGRAM_VOICES: Record<string, { default: string; voices: string[] }> = {
  "pt-br": {
    default: "aura-stella-en", // Deepgram doesn't have PT-BR native, use warm English voice
    voices: ["aura-stella-en", "aura-luna-en", "aura-athena-en"]
  },
  "en-us": {
  ...
  "en-gb": {
    ...
    voices: ["aura-athena-en", "aura-luna-en", "aura-stella-en"]
  },
  "es": {
    default: "aura-stella-en",
    voices: ["aura-stella-en", "aura-luna-en"]
  },
  "fr": {
    default: "aura-athena-en",
    voices: ["aura-athena-en", "aura-luna-en"]
  },
  "de": {
    default: "aura-orion-en",
    voices: ["aura-orion-en", "aura-zeus-en"]
  },
  "it": {
    default: "aura-stella-en",
    voices: ["aura-stella-en", "aura-luna-en"]
  ...
  "hi": {
    default: "aura-orion-en",
    voices: ["aura-orion-en", "aura-arcas-en"]
  }
};

// Map legacy voice IDs to Deepgram voices
const VOICE_MAPPING: Record<string, string> = {
  // Female voices
  "clara": "aura-asteria-en",
  "nova": "aura-stella-en",
...
serve(async (req) => {
  ...
  try {
    ...
    // First try direct mapping, then language default
    let resolvedVoice = VOICE_MAPPING[lowerVoiceId];
    if (!resolvedVoice) {
